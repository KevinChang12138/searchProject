                ...
                <div class="sbtc" id="sbtc">
                    <div class="sbibtd">
                        ...
                        <div class="sbibod " id="sfdiv">
                            <button class="sbico-c" onclick="search();return false;" value="Search" id="searchButton" name="searchButton"
                            ...
                            <div class="lst-c">
                                <div class="gstl_0 sbib_a" style="height: 44px;">
                                    ...
                                    <div class="sbib_b" id="sb_ifc0" dir="ltr">
                                        <div id="gs_lc0" style="position: relative;"><input class="gsfi" id="tags"
                                                                                            maxlength="2048" name="tags"
                                                                                            autocomplete="off"
            ...
            <div id="extabar">
                <div id="topabar" style="position:relative">
                    <div class="ab_tnav_wrp" id="slim_appbar">
                        <div id="sbfrm_l">
                            <div id="resultStats">About ${list?size} results
                                <nobr> (${timeAll} seconds)&nbsp;</nobr>
                            </div>
                        </div>
                    </div>
                </div>
